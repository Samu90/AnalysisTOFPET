...
void GetPedestal(TTree* tree, TH1D* histoCh1, TH1D* histoCh2){
...
void FillETime(TTree* tree, TH2D* HistoCh59,TH2D* HistoCh315, Double_t MeanPedCh59, Double_t MeanPedCh315){
...
void GetProfiles(TH2D* HistoCh59, TH2D* HistoCh315,Double_t* X,std::vector<std::vector<Double_t> >& Y,string dir){
  ...
  Double_t XMin=HistoCh59->GetXaxis()->GetXmin();
  ...
  for(int k=0;k < Nbins;k++){
    ...
    X[k]=XMin+(XMax-XMin)/Nbins*(k+1)-(XMax/Nbins)/2;
